...
public class TestHerencia {
    public static void main(String[] args) {
        ...
        /* Comentamos porque al ser clase abstracta no me deja crear objetos.
        ...
        System.out.println(persona4);
        persona4.saludar();
        //Persona 2 se muda  a la direccion de persona 1
        ...
        */
        ...
        Cliente cliente1 = new Cliente(1, new Cuenta(1,"args"), "Karina", "Molina", 20, direccion2);
        cliente1.saludar();
        ...
        //Mismo método tienen pero saludan distinto, es decir, tienen distinto comportamiento.
        p1.saludar();
        p2.saludar();
